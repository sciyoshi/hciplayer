...
+ (UIImageView *) getAnimationForGifAtUrl:(NSURL *)animationUrl forUIImageView:(UIImageView*)uiv
{   
    
    AnimatedGifQueueObject *agqo = [[AnimatedGifQueueObject alloc] init];
    [agqo setUiv: uiv]; // 2x retain, alloc and the property.
