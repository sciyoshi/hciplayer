...
@property AudioFileStreamID audioFileStream;
@property unsigned int fillBufferIndex;
@property size_t bytesFilled;
@property size_t packetsFilled;
@property NSInteger buffersUsed;
@property OSStatus err;
@property 	bool discontinuous;
@property CFReadStreamRef stream;
@property (retain) NSNotificationCenter *notificationCenter;
@property NSUInteger dataOffset;
@property 	bool seekNeeded;
@property double seekTime;
@property double sampleRate;
@property (getter=progress) double lastProgress;
@end
